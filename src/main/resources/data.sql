...
INSERT INTO p_reviews ( review_id, store_id, store_name, user_id, rating, comment, is_public, created_at, created_by)
SELECT gen_random_uuid(), s.store_id, s.store_name, 'user001', FLOOR(RANDOM() * 5 + 1)::smallint, '자동 생성된 리뷰입니다.', true, now(), 'user001'
FROM p_stores s LIMIT 2;
